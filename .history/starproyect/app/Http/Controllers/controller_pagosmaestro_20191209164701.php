    ...
    public function storeDetallePago(Request $request, $id_pago){
        try{
           ...
           /*$detalle = new pagosdetalle([					
                ...
                'vlor_capital_pgdo' => $request->input('vlor_capital_pgdo'),
                'vlor_interes_pgdo' => $request->input('vlor_interes_pgdo'),
                'id_credito_detalle' => $request->input('id_credito_detalle')
            ]);*/
