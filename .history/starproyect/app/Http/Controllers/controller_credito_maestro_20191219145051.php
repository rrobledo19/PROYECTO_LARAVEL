...
class controller_credito_maestro extends Controller
{
    ...
    public function show_x_cliente($id_cliente)
    {
        ...
        try{
            ...
            $credito_maestro = credito_maestro::select(DB::raw('id_credito,fecha_credito as Fecha_Credito,fecha_vencimiento as Fecha_Vencimiento'))->where('id_cliente', '=', $id_cliente)->get();
