...
class controller_pagosmaestro extends Controller
{
   ...
   /* public function mincouta($id_credito){
    ...
    public function storeDetallePago(Request $request){
        try{

            /*  id int(11) AI PK 
                id_pagos bigint(20) 
                fecha_pago datetime 
                nro_coutas bigint(20) 
                vlor_couta decimal(16,2)*/
            ...
            foreach($datos_detalle as $d){
                ...
                $detalle = new model_credito_detalle([					
					'id_pagos' => $d->id_credito,
                    'fecha_pago' => $d->nro_coutas,
                    'nro_coutas' => $d->fecha_credito,
                    'vlor_couta' => $d->vlor_capital
				]);
